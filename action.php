...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["search_item"])){
...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
            ...
            echo '<div class="cart-summary"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				    <small class="qty">'.$n.' Item selected</small>
