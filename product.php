			...
			<div class="container">
				...
				<div class="row">
					...
					<?php 
								...
								$sql = " SELECT * FROM products,categories WHERE product_cat=cat_id AND  product_id = $product_id";
								if (!$con) {
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">'.$row['product_price'].'<del class="product-old-price">'.$row['product_mrp'].'</del></h3>
