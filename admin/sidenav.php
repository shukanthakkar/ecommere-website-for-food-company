  ...
  -->
      ...
      <div class="sidebar-wrapper ps-container ps-theme-default" data-ps-id="3a8db1f4-24d8-4dbf-85c9-4f5215c1b29a">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="supplierlist.php">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="enquiry_data.php">
              <i class="material-icons">edit_user</i>
              <p>Supplier Enquiry</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="shop_enquiry.php">
              <i class="material-icons">edit_user</i>
              <p>Shop Enquiry</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="cust_enquiry.php">
              <i class="material-icons">edit_user</i>
