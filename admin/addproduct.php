...
mysqli_query($con,"insert into products (product_cat,product_title,product_price,product_mrp, product_desc, product_image,product_keywords) values ('$product_type','$product_name','$price','$mrp','$details','$pic_name','$tags')") or die ("query incorrect");
